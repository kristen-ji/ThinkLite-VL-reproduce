...
# This gets the directory containing the current script
base_dir = os.path.dirname(os.path.abspath(__file__))
template_file = os.path.join(base_dir, "sbatch_template.sh")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help="Number of GPUs to use in each node. (Default: 1)"
    )
    parser.add_argument(
        "--partition", "-p", type=str, default="accelerated",
    )
    parser.add_argument(
        "--load-env", type=str, default="",
        help="The script to load your environment, e.g. 'module load cuda/12.8'"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        '--time', type=str, default="02:00:00", 
